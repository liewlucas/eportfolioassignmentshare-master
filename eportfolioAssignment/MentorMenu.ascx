<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MentorMenu.ascx.cs" Inherits="eportfolioAssignment.MentorMenu" %>
...
<nav class="navbar navbar-expand-md bg-light navbar-light">
    ...
    <div class="collapse navbar-collapse" id="staffNavbar">
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="ApproveStudent.aspx">Approve Student's Portfolio</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="PostSuggestions.aspx">Post Suggestions For Improvements</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="SearchStudentSkill.aspx">Search for Students with Skill Set</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="ViewReplyMentor.aspx">View Replies</a>
            </li>
            <li class="nav-item">
